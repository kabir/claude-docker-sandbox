...
**Implementation**: When `-c` flag is set, creates copy before mounting. Tracks copies for cleanup summary. Shows rsync commands to merge back.
...
| `clean-copies` | Remove copies | `./claude-pod.sh clean-copies --old 7` |
...
- **v2.0** (Current): User-friendly improvements, profiles, shell completion
